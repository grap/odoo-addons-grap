...
-------------------------------
    ...
    * Licence: AGPL-3 (http://www.gnu.org/licenses/);""",
    ...
    'data': [
        ...
        'view/view_ir_values.xml',
        'view/view_mail_compose_message.xml',
        ...
        'view/view_product_pricelist_item.xml',
        'view/view_product_supplierinfo.xml',
        'view/view_res_company.xml',
        'view/view_res_partner.xml',
        'view/view_res_users.xml',
        'view/view_sale_order.xml',
        'view/view_workflow_instance.xml',
        'view/view_workflow_workitem.xml',
        'view/action.xml',
        'view/menu.xml',
    ],
    'css': [
