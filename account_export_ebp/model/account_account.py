...
#Columns section
    _columns = {
        ...
        'export_tax_code': fields.boolean('Export according to Tax Codes', 
            help="""
...
#Constraints section
    ...
    _constraints = [
        (_check_code_length, 'The account code for a partner account cannot\
        exceed 3 characters, so as to permit the EBP export', ['code', 'type']),
        ]
