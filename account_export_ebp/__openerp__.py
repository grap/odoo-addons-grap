...

{
    ...
    'version' : '2.2',
    'author' : u'Numérigraphe SARL / GRAP SCIC SARL',
...
The exported moves cannot be changed or deleted anymore, but the export can be reverted by unchecking the "exported" box.

Three pieces of configuration need to be set:
- the company for each fiscal year
- the URI, user name and password of to access the EBP folders as Windows network shares (if you want to save the files directly in EBP folder)
- the number of each fiscal year in these folders
The files will be directly generated in the EBP network shares or can be downloaded on the user's computer.
...
A menu allow the user to see the list of all past exports and download again old ones if need be.
''',
    'depends' : [
        'account_accountant',
        'base_fiscal_company',
