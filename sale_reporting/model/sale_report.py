...
class sale_report(Model):
    ...
    _columns = {
        'categ_id2': fields.many2one('product.category','Category2', readonly=True),
        'categ_id3': fields.many2one('product.category','Category3', readonly=True),
        ...
        cr.execute("""
            create or replace view sale_report as (
                select
                    ...
                    (sum(l.product_uom_qty*l.price_unit)/sum(l.product_uom_qty / u.factor * u2.factor))::decimal(16,2) as average_price,
                    count(*) as nbr,
